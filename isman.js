...
module.exports = isman = async (isman, m, chatUpdate, store) => {
	...
	try {
        ...
        if (m.message) {
            ...
            console.log(chalk.black(chalk.bgWhite('[ ISMAN ]')), chalk.black(chalk.bgBlue(new Date)), chalk.black(chalk.bgBlue(budy || m.mtype)) + '\n' + chalk.magenta('=> Dari'), chalk.blue(pushname), chalk.yellow(m.sender) + '\n' + chalk.blueBright('=> Di'), chalk.blue(m.isGroup ? pushname : 'Private Chat', m.chat))
        }
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await isman.setStatus(`${global.author} | Runtime : ${runtime(uptime)}`)
...
isman.sendMessage(m.chat, { video: smeme, mimetype: 'sofovi/intro.mp4', fileName: `subrek.mp4`, caption: `Betewe Lu Dah Janji Mau Subscribe\n\nJangan PHP Yah 😊\n\nSubscibe:https://youtube.com/c/IsmanFF`},{ quoted: m })} break
...
case 'runtime': {
                ...
                respon = `
Kecepatan Respon ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : 3 week, 18 days, ${runtime(process.uptime())}
...
isman.sendMessage(m.chat, {audio: man2, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
 isman.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `ismanv2.zip`}, {quoted:m})}
            ...
            isman.sendMessage(m.chat, {document: ana, mimetype: 'application/json', fileName: `Isman.json`}, {quoted:m})}
            break
            
             case 'sessionzip': {
            ana = fs.readFileSync('./Isman.json')
            isman.sendMessage(m.chat, {document: ana, mimetype: 'application/zip', fileName: `Isman.json`}, {quoted:m})}
            break
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await isman.sendButtonText(m.chat, buttons, `Mode Antilink`, global.author, m)
                }
             }
            break
            case 'join': {
	...
	break
            ...
            case 'list': case 'menu': case 'help': case '?': {
                ...
                isman.sendMessage(m.chat, { image: menuku, caption: `_Selamat Datang Di IsmanBot_\n\n _Ada Yang Bisa Kami Bantu Kak ${m.pushName} ☺🙏_
